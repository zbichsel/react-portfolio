                ...
                <div className={div6}>
                    ...
                    <div className={div7}>
                        <a
                            ...
                            className={a2}
                        >
                            <svg className="h-5 text-zinc-50 dark:text-white" fill="none" viewBox="0 0 20 20">
                        ...
                        <a
                            ...
                            className={a2}
                        >
                            <svg className="h-5 text-zinc-50 dark:text-white" fill="currentColor" viewBox="0 0 15 15">
                        ...
                        <a
                            ...
                            className={a2}
                        >
                            <svg className="h-5 text-zinc-50" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a
                            ...
                            className={a2}
                        >
                            <svg className="h-5 text-zinc-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 20">
