export const navWrapper = "bg-purple-900 m-0 relative";
...
export const itemsul = "font-medium flex flex-col p-4 w-full items-center justify-center divide-y md:divide-none md:p-0 mt-4 border border-zinc-50 rounded-lg bg-purple-900 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-purple-900";
